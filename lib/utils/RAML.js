    ...
    _createClass(RAML, [{
        ...
        value: function loadRAMLFile() {
            ...
            return new Promise(function (resolve, reject) {
                _this.parser.loadFile(_this.resolvedRamlPath).then(function (parsedData) {
        ...
        value: function getRouteMap() {
            ...
            function resourcesParser(resources, parentResource, ast) {
                var routeMap = [],
                    defaultAuthStrategies = undefined;
                ...
                resources.forEach(function (resource) {
                    ...
                    if (resource.resources) {
                        var mappedRoutes = resourcesParser(resource.resources, resource, ast);
